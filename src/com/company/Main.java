...
//      Заполняем символьный массив символами строки которую ввел пользователь и по ходу ловим знак операции
        ...
        if (blacks.length == 1 | blacks.length == 0) {
            ...
            if (number1 == -1 & number2 == -1) {
                ...
                result = calculated(number1, number2, operation);
                if (result < 0) {
                    throw new InputMismatchException("//т.к. в римской системе нет отрицательных чисел");
                }
